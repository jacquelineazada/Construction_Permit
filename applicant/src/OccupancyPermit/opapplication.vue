      ...
      <v-container fluid class="pa-0">
        ...
        <v-container fluid class="px-4 mx-auto" style="max-width: 1300px">
          <v-stepper alt-labels class="mb-4" flat>
            <v-stepper-header>
              <v-stepper-item title="Application" value="1" color="blue"></v-stepper-item>
              <v-divider style="border-width: 2px; border-color: blue"></v-divider>
              <v-stepper-item title="Owner/Applicant" value="2"></v-stepper-item>
              <v-divider style="border-width: 2px"></v-divider>
              <v-stepper-item title="Location & Scope of Work" value="3"></v-stepper-item>
              <v-divider style="border-width: 2px"></v-divider>
              <v-stepper-item
                      ...
                      <v-col cols="12" md="6">
                        ...
                        >
                          <div class="d-flex align-center">
                            ...
                            <v-icon
                              :color="
                                selectedApplicationType === 'partial' ? 'blue' : 'grey'
                              "
                              >mdi-home</v-icon
                            >
                          </div>
