                  ...
                  <div class="custom-timeline-container">
                    ...
                    <div class="custom-timeline-item">
                      ...
                      <div class="timeline-content">
                        ...
                        <div class="text-caption">Application ID: BP-2024-001</div>
                        <div class="text-caption">Pending documents verification</div>
                        <div class="mt-1 text-caption">
                          Requirement checking will begin shortly. Your submitted
                          requirements will be reviewed for completeness and accuracy.
                        </div>
                      </div>
                    ...
                    <div class="custom-timeline-item">
                      ...
                      <div class="timeline-content">
                        ...
                        <div class="text-caption">Application ID: BP-2024-001</div>
                        <div class="text-caption">Pending inspection schedule</div>
                        <div class="mt-1 text-caption">
                          Wait for your onsite inspection schedule once required documents
                          are approved.
                        </div>
                      </div>
                      <v-chip outlined class="timeline-status-chip">Pending</v-chip>
